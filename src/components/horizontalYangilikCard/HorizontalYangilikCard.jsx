      ...
      <div className="card blog-horizontal">
        <div className="card-body">
          ...
          <div>
            ...
            >
              Yerlarimiz shiddat bilan ishdan chiqyapti, chunki... tayinli egasi
              yo‘q
            </h2>
          </div>
          ...
          >
            ...
            xususiy egalik qilish huquqi nafaqat agrar davlatning rivoji uchun,
            balki butun boshli xalqning irsiy fondini saqlab qolish uchun ham
            kerak. Bu haqda Kun.uz kolumnisti Shahzod Yo‘ldoshboyev fikr
            yuritadi. Oxirgi haftalarning shiddatli xabarlari oqimi orasida bir
            muhim xabar, nazarimda, jamoatchilik nazaridan chetda qoldi –
            O‘zbekiston Respublikasi Konstitutsiyasiga kiritilishi taklif
            etilgan o‘zgarishlar qatorida uning 55-moddasini o‘zgartirish taklif
            etildi. Qanday taklif bu? Hozirda O‘zbekistonda dehqon va fermerlar
            yerlarni xususiy mulkka olishi imkoniyati yo‘q. Taklif mazkur
            me’yorni Konstitutsiyada mustahkamlashni nazarda tutyapti.
          </p>
        </div>

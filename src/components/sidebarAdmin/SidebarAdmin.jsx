                        ...
                        <li className="nav-item nav-item-submenu axborot_xizmati" style={{ display: "block" }}>
                            ...
                            <ul className="nav-item-ul" style={{ display: "none" }}>
                                <li className="nav-item">
                                    <Link to="/axborot_xizmati/yangiliklar" className="nav-link liHover" style={{ fontSize: '18px' }}>
                                ...
                                <li className="nav-item">
                                    <Link to="/axborot_xizmati/hokimning_nutqi" className="nav-link liHover" style={{ fontSize: '18px' }}>
                                        <i className="icon-magazine" style={{ color: "#0056B8" }} />

...
function Information() {
  ...
  const handlePageClick = (e) => {
    ...
    console.log(1);
    axiosInstance.get(`news/getAll?size=${size}&page=${e.selected}`).then(res => {
      console.log(res.data);
      setData(res.data.content)
      setTotalElements(res.data?.totalElements)
    })
        ...
        <div className="tab-pane fade show active bg-white" id="colored-tab1">
          <div className="card-body py-2">
            <div className="d-flex" style={{ alignItems: "center", justifyContent: "space-between" }}>
              <h3 style={{ margin: "10px 0", fontWeight: "bold", textTransform: "uppercase" }}>Informatsion yangilik</h3>
                  ...
                  data?.map((item, index) => {
                    return (
                      <tr key={item.id}>
                        ...
                        <td className="text-center">
                          <button onClick={() => setEditModal({ isShow: true, data: item })}
                            type="submit"
                            title="O'zgartirish"
                                    ...
                                    <div className="tab-content">
                                      ...
                                      <div className="tab-pane fade show active" id="basic-tab1">
                                        ...
                                        <div className="templateCkeditor1">
                                          <CkeEditor handleFunction={handleFunction1} />
                                        </div>
                                      </div>
                                      ...
                                      <div className="tab-pane fade" id="basic-tab2">
                                        ...
                                        <div className="templateCkeditor2">
                                          <CkeEditor handleFunction={handleFunction2} />
                                        </div>
                                      </div>
                                      ...
                                      <div className="tab-pane fade" id="basic-tab3">
                                        ...
                                        <div className="templateCkeditor3">
                                          <CkeEditor handleFunction={handleFunction3} />
                                        </div>
                                      </div>
                                    </div>
                                  </div>

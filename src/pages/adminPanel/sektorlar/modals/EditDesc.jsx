...
const EditDesc = ({ Alert, setAlert, setEditDesc, editDesc, govGroup, setGovGroup }) => {
  ...
  const editDescFunc = async (e) => {
    ...
    console.log(1);
    try {
      const sendingData = { ...editDesc.data }
      sendingData.uzDescription = newsData1 ? newsData1 : editDesc.data.uzSectorArea
      sendingData.krDescription = newsData2 ? newsData2 : editDesc.data.krSectorArea
      sendingData.ruDescription = newsData3 ? newsData3 : editDesc.data.ruSectorArea
      ...
      <div style={{ width: "75%", margin: "0 auto" }}>
        <div className="modal-content">
          <div className="modal-header bg-primary text-white">
            <h5 className="modal-title">Qisqacha ma'lumot</h5>

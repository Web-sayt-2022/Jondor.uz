...
const Tegs = () => {
  ...
  const addFunc = () => {
    if (data.length >= 8) {
      Alert(setAlert, "warning", "Teglar 8 ta ziyot bo`lishi mumkin emas!")
    } else {
      setAddCarousel(true)
    }
  }
    ...
    <div className="card-body p-0 pt-3 px-3">
      <div className="card px-3 py-2" style={{ minHeight: "100vh" }}>
        ...
        <div className="d-flex mb-2" style={{ alignItems: "center", justifyContent: "space-between" }}>
          <h3 style={{ margin: "10px 0", fontWeight: "bold", textTransform: "uppercase" }}>Teglar</h3>
...
export default React.memo(Tegs);

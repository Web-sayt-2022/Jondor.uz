...
import "./tarkibiyBolinmalarPage.css";

const TarkibiyBolinmalarPage = () => {
  return (
                  ...
                  <div className="card">
                    ...
                    >
                      <div className="card-body p-2">
                        ...
                        placeat reprehenderit ipsum enim nobis ut, nostrum harum
                        doloremque illo ad quisquam dolores in quo natus quam?
                        Quas ab alias facere deserunt voluptatum magni ipsa
                        quidem, eos aperiam molestiae corporis temporibus
                        quibusdam laborum placeat cum nam minus accusamus quod
                        deleniti? Beatae hic corrupti fugit deserunt accusamus
                        esse illum modi? Sed labore tenetur praesentium ad quia
                        expedita in itaque dolore vitae impedit, odio qui
                        ...
                        facilis obcaecati libero eius non temporibus, cum enim!
                        Aut, eum nobis voluptates earum eligendi nostrum
                        accusantium consequatur quis non perferendis cum
                        repudiandae deleniti reiciendis ipsam error veniam a.
                        Culpa ab eaque sunt quaerat modi? Nisi sunt eos sapiente
                        quo maiores consequatur aut atque reiciendis veritatis
                        quas modi soluta, quasi tempora aliquid? Modi, totam
                        provident recusandae molestiae eaque sapiente obcaecati
                        iusto sunt, rem similique corporis error autem. Rerum
                        ipsum, nobis voluptate quo sint accusamus distinctio,
                        eligendi natus dolores, vel quam nihil dolorum officia.
                        Perspiciatis delectus cumque facere repudiandae quod
                        omnis quidem ipsum?
                      </div>
                    </div>
                  </div>
                    ...
                    >
                      <div className="card-body body-elements">
                        <div className="img d-flex align-content-center justify-content-center">
                          <img src="../images/person.jpg" alt="" className="" />
                        </div>
                          ...
                          <div className="person">
                            <div className="my-3 person-info">
                              ...
                              >
                                ...
                                kambag'allikni qisqartirish masalalari bo'yicha
                                birinch o'rinbosari
                              </p>
                            </div>
...
export default TarkibiyBolinmalarPage;
